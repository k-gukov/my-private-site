...
function getCJSElement(type,obj,divId,xmlElement)
{
	...
	switch(type)
	{
		...
		case "ROUTER":
			...
			break;	
			case "ROUTER_SYNTAX":
				element = new RouterSyntaxComp(obj);
			break;			
		case "BUBBLE":
...
(VideoComp = function (obj) {
	...
	if(obj.api == "youtube"){
		...
		function brightcoveLoaded(){
	        ...
	        '<param name="playerID" value="2649990253001" />'+
	        '<param name="playerKey" value="AQ~~,AAACaPvlvkE~,zCw2Hw90_KSOCz6LjW5G7qKEj3mIN-3H" />'+
			...
			setTimeout(brightcove.createExperiences, 100);
		}
...
/********************************************************************************************************************************
													RouterSyntax Output Component
													-----------------------
	<element type="ROUTER" textId="ID_s1_txt04" x="0" y="250" width="450" height="100"/>
*********************************************************************************************************************************/
(RouterSyntaxComp = function(obj){
	this.initialize();
...
(BubbleComp = function (obj) {
	...
	if((obj.tailPosition == "2") || (obj.tailPosition == "3") ||(obj.tailPosition == "4") ||(obj.tailPosition == "8") ||(obj.tailPosition == "9") ||(obj.tailPosition == "10")) width = width-10;
	obj.wid = width;	
	textComp = new TextComp({subType:"BUBBLE",compId:obj.compId,x:7,y:0,size:obj.size,div:obj.div,width:width-6,height:height-6,align:obj.align,bgColor:obj.bgColor,borderColor:obj.borderColor,corner:2,border:3,expand:"down"});
...
(TextBoxComp = function(obj){
	...
	{		
		...
		textComp = new TextComp({compId:id,x:25,y:12,width:width-36,size:12,div:obj.divId+'_title',color:"#393536"});
	...
	th.setBodyId = function(id)
	{
		...
		obj.style = 'font-family:'+"CiscoSansTTLight;"+"overflow:auto !important; height:"+(height-20)+"px;"+"line-height:"+"1.5";
			textComp = new TextComp({compId:id,x:26,y:bodyTextY-5,width:width-17,size:11,color:"#0a0a0a",style:obj.style,div:obj.divId+'_body'});
		th.addChild(textComp);
	}	
	...
	{				
		...
		//th.addChild(textComp);
			...
			titleHeight = $("#"+obj.titleId).height()+8;
...
(BlueButton = function(obj){
	...
	var label = new TextComp({x:0,y:0,width:obj.width-2,compId:obj.compId,align:"center",color:"#343434",div:obj.div,bold:obj.bold,style:"pointer-events:none;cursor:pointer;"+"line-height:"+"1.1"});
	th.addChild(label);	
	
	label.y = $("#"+obj.compId).height() < 20 ? ((20-$("#"+obj.compId).height())/2 ): ((obj.height-$("#"+obj.compId).height())/2)+4;
