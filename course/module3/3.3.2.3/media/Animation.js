...
//	this.text_1 = new cjs.Text("ID_txt04", "11px Arial", "#393536");
	...
	//this.text_2 = new cjs.Text("ID_txt05", "11px Arial", "#393536");
 	this.text_2 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_txt05", width:"128",  expand:"down"}); 
...
(lib.ID_bubble02 = function() {
	...
	this.text_6.setTransform(34.2,0);
...
(lib.ID_bubble01 = function() {
	...
	// Layer 1
	this.text_7 = new DOMObject({ type:"BUBBLE", compId:"ID_bubble01",  width:"240", height:"55", align:"left",  tailPosition:"7", tailFlip:"0",divId:"bubble1" }); 
...
(lib.arpreply = function() {
	...
	this.text_9 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt08", width:"52",  size:"10", expand:"up+down"}); 
