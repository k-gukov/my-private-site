...
(slide1 = function(slideContainer){
	...
	btn = getCJSElement("BLUE_BUTTON",{x:86.75,y:320,width:145,height:30,compId:"ID_s1_btn01",callback:btnHandler,id:"1"});
	btn.setSelected(true);
	slideContainer.btn_1 = btn;	
	slideContainer.addChild(btn);
	
	btn = getCJSElement("BLUE_BUTTON",{x:247.55,y:320,width:115,height:27,compId:"ID_s1_btn02",callback:btnHandler,id:"2"});
