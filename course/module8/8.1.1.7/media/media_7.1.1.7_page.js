...
(slideViewDidLoad = function(_container,_id)
 {	
	...
	$("#commonMediaText").append('<input id="val8" style="width:37px; left:0px; top:0px;"/>');	
			...
			dom.y = 159;				
			_container.addChild(dom);
            $("#val8").attr('maxlength','2');
		
	//get bit ans
	$("#commonMediaText").append('<input id="show" style="width:70px; left:0px; top:0px;" disabled="true" />');	
...
//for check button
		...
		feeback = getCJSElement("TEXTBOX",{subType:"CLOSABLE",x:359.15,y:269.1,width:368,height:110,titleId:"ID_INCORRECT_TITLE",bodyId:"ID_INCORRECT_BODY",visible:"0"});			  
