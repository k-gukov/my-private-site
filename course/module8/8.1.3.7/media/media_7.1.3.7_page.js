...
(slideViewDidLoad = function(_container,_id)
{
		...
		var textBox;
		textBox = getCJSElement("TEXTBOX",{x:242.6,y:298.85,width:460.05,height:105, subType:"CLOSABLE", titleId:"ID_CORRECT_TITLE", bodyId:"ID_CORRECT_BODY"});
		...
		btn = getCJSElement("BLUE_BUTTON",{x:218.4,y:270.7,width:108,height:21,size:12,id:"check",compId:"ID_btn01", callback:buttonHandler});
		_container.addChild(btn);
		
		btn = getCJSElement("BLUE_BUTTON",{x:354.8,y:270.7,width:108,height:21,size:12,id:"reset",compId:"ID_btn02", callback:buttonHandler});
		_container.addChild(btn);
	
		btn = getCJSElement("BLUE_BUTTON",{x:491.2,y:270.7,width:108,height:21,size:12,id:"newNum",compId:"ID_btn03", callback:buttonHandler});
		_container.addChild(btn);
		
		btn = getCJSElement("BLUE_BUTTON",{x:627.7,y:270.7,width:108,height:21,size:12,id:"showMe",compId:"ID_btn04", callback:buttonHandler});
		_container.addChild(btn);
