...
(lib.text_upper_1 = function() {
	...
	// Layer 1
	this.text_1 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_s2_txt01", width:"120", expand:"up",size:10});
...
(lib.FakedTable = function() {
	...
	this.text_115 = new TextComp({subType:"TABLE",x:"0",y:"0",width:"420",height:"95",size:"11",compId:"ID_s2_table"});
...
(lib.text_left = function() {
	...
	// Layer 1
	this.text_2 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_s2_txt09", width:"99", expand:"down",size:10});
...
(lib.label = function() {
	...
	this.text_3.setTransform(17,126.2);
	...
	this.text_5.setTransform(15,3.2);
...
(lib.ID_s2_txt11 = function() {
	...
	this.text_6.setTransform(3,1.2);
...
(lib.ID_s2_txt07 = function() {
	...
	// Layer 1
	this.text_7 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_s2_txt07", width:"100", expand:"up+down",size:10});
	this.text_7.setTransform(-2,9);
...
(lib.ID_s2_txt05 = function() {
	...
	// Layer 1
	this.text_8 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_s2_txt05", width:"123", expand:"down",size:10});
	this.text_8.setTransform(1,1);
