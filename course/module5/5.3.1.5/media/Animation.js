...
// symbols:
(lib._1_2_1_3 = function() {
	this.initialize(img._1_2_1_3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,470,400);


(lib.computerpngcopy = function() {
	this.initialize(img.computerpngcopy);
}).prototype = p = new cjs.Bitmap();
...
(lib.ID_s2_txt02 = function() {
	...
	// ID_s2_txt02
	this.text= new DOMObject({type:"TEXT",compId:"ID_s2_txt02",width:"76.2",expand:"down",align:"center"});	
	this.addChild(this.text);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,76.2,29.4);
...
(lib.ID_s2_txt01 = function() {
	...
	// ID_s2_txt01
	this.text= new DOMObject({type:"TEXT",compId:"ID_s2_txt01",width:"76.2",expand:"down",align:"center"});	
	this.addChild(this.text);
...
(lib.packet_box_empty = function() {
	...
	this.instance.setTransform(-0.9,-10.9);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-0.9,-10.9,46,12);
...
p.nominalBounds = new cjs.Rectangle(0,-38,92,39);
...
(lib.Switchworkgroup = function() {
	...
	this.instance.setTransform(0,-61.9,0.78,0.78);
...
(lib.Serverfile = function() {
	...
	this.instance.setTransform(0,-86.3,0.623,0.622);
...
(lib.computer = function() {
	...
	this.instance.setTransform(0,-73.9,0.623,0.624);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(295).wait(61).to({alpha:1},0).wait(57).to({alpha:0},23).wait(218));

	// packet box empty
	this.instance_10 = new lib.packet_box_empty();
	this.instance_10.setTransform(140,191.8,1,1,0,0,0,22.3,-5.5);
	this.instance_10.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(127).to({alpha:1},0).to({x:275.7},55).wait(1).to({alpha:0},0).wait(406).to({x:280.7,alpha:1},0).to({x:394.4},54).to({x:400.7,alpha:0},2).wait(9));

	// packet_box
	this.instance_11 = new lib.packet_2instance4();
	this.instance_11.setTransform(268.4,194.1,0.474,0.474,0,0,0,45.1,-26.7);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(458).to({scaleX:1,scaleY:1,x:348.6,y:127.1,alpha:1},28).wait(65).to({alpha:0},20).wait(83));
	// Layer 2
	this.instance_12 = new lib.ID_s2_txt02();
	this.instance_12.setTransform(398.1,229.3,1,1,0,0,0,38.1,8.5);

	this.instance_13 = new lib.ID_s2_txt01();
	this.instance_13.setTransform(135.1,226.3,1,1,0,0,0,38.1,8.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13},{t:this.instance_12}]}).wait(654));
	...
	// lines
	this.instance_13 = new lib._1_2_1_3();
	this.instance_13.setTransform(0,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13}]}).wait(654));
