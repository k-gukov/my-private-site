...
(lib.label2 = function() {
	...
	this.text.setTransform(360,236.2);
	...
	this.text_2.setTransform(71,168.2);

	this.text_3 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_s2_txt02", width:"160", expand:"up+down",size:10});
	this.text_3.setTransform(288,6.2);

	this.text_4 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_s2_txt01", width:"200", expand:"down",size:10});
...
(lib.label = function() {
	...
	this.text_10 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_s1_sourceMAC", width:"102", expand:"down",size:10});
	this.text_10.setTransform(106,2);

	this.text_11 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_s1_destMAC", width:"91", expand:"down",size:10});
...
(lib.frame = function() {
	...
	// TEXT
	this.text_13 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_s2_txt04", width:"41", expand:"up+down",size:10});
	this.text_13.setTransform(-160.4,62);
