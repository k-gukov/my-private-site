...
(slideViewDidLoad = function(container,id){
	...
	var send_btn = getCJSElement("BLUE_BUTTON",{x:179,y:350,width:105,height:21,size:12,id:"check",compId:"ID_send",
	callback:send_action});
	container.addChild(send_btn);
	
	var reset_btn = getCJSElement("BLUE_BUTTON",{x:179,y:350,width:105,height:21,size:12,id:"reset",compId:"ID_reset",
	callback:reset_action});
	container.addChild(reset_btn);
