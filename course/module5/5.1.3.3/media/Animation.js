...
(lib.lazy_txt = function() {
	...
	// Layer 1
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_txt04", width:"94", expand:"up+down",size:9});
	this.text.setTransform(375,-10);
	...
	this.text_2.setTransform(292,248.2);
	...
	this.text_4.setTransform(211,206);
	...
	this.text_7.setTransform(414,184.2);

	this.text_8 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt07", width:"60", expand:"up+down",size:9});
	this.text_8.setTransform(351,184.2);

	this.text_9 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt09", width:"60", expand:"up+down",size:9});
	this.text_9.setTransform(286,184.2);
	...
	this.text_13.setTransform(150,112);

	this.text_14 = new DOMObject({type:"TEXT" , align:"right" ,compId:"ID_txt03", width:"88", expand:"up+down",size:9});
	this.text_14.setTransform(-2,27);
...
(lib.bublle1 = function() {
	...
	// Layer 1
	this.text_15 = new BubbleComp({x:"0",y:"0",width:"200",size:"11",compId:"ID_bubble_01",align:"left",tailPosition:"6",tailFlip:"1",extend:"right"});
...
//	this.text_15.lineHeight = 13;
	this.text_15.setTransform(3,8.2);
