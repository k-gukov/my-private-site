...
(lib.WAN_Trailer = function() {
	...
	this.text = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt03", width:"85",  size:"11", expand:"right",class:"lightYellowBg"}); 
...
(lib.WAN_Header = function() {
	...
	this.text_1 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt04", width:"75",  size:"11", expand:"left",class:"lightYellowBg"}); 
...
(lib.txt01a = function() {
	...
	this.text_2 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt01a", width:"75",  size:"11", expand:"left+right",class:"orangeBg"}); 
...
(lib.LAN_trailer = function() {
	...
	this.text_3 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt01", width:"68",  size:"11", expand:"right",class:"lightGreenBg"}); 
...
(lib.LAN_header = function() {
	...
	this.text_4 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt02", width:"73",  size:"11", expand:"left",class:"lightGreenBg"}); 
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{},true);
	...
	this.instance_1.setTransform(-1,79.3);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(134).to({alpha:1},17).wait(25).to({x:233},38).wait(1));

	// ID_txt02
	this.instance_2 = new lib.LAN_header();
	this.instance_2.setTransform(0,284.3);
	...
	this.instance_4.setTransform(160,284.3);
	...
	this.text_5 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_txt07", width:"195",  size:"11", expand:"up+down",class:"orangeCallOut"}); 

	this.text_5.setTransform(240,210);
	...
	this.text_7 = new DOMObject({type:"TEXT" , align:"right" ,compId:"ID_txt06", width:"101",  size:"11", expand:"up+down"}); 
	this.text_7.setTransform(10,180.8);
