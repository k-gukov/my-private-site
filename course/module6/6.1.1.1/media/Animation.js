...
(lib.textlabel = function() {
	...
	this.text_1 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_txt02", width:"100", expand:"up+down"});
/*
	this.text_1 = new cjs.Text("ID_txt02", "10px Courier New");
	this.text_1.lineHeight = 16;*/
	this.text_1.setTransform(355,1);
	...
	this.text_2.setTransform(68,-1.9);
...
(lib.data_blank = function() {
	this.initialize();
this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_txt16", width:"100", expand:"up+down"});
	this.text.setTransform(-21,-5);
