...
/* feedback */
	feeback = getCJSElement("TEXTBOX",{subType:"CLOSABLE",x:230.15,y:313.65,width:531,height:97.35,titleId:"ID_INCORRECT_TITLE",bodyId:"ID_INCORRECT_BODY",visible:"0"});			  
	_container.addChild(feeback);
		
/* Core function */
$("input[mode=subnetMaskBin]").focus(function (evt) {
	feeback.visible=0;
});
...
/* check function */	
	...
	//alert(mediaStage);
	btn = getCJSElement("BLUE_BUTTON",{x:368.35,y:275.85,width:108,height:21,size:12,compId:"ID_btn01",callback:checkBit});
	_container.addChild(btn);
	
	btn = getCJSElement("BLUE_BUTTON",{x:508.55,y:275.85,width:120,height:21,size:12,compId:"ID_btn02",callback:resetBit});
	_container.addChild(btn);
