...
(lib.lazy_txt = function() {
	...
	this.text_7.setTransform(406,184.2);

	this.text_8 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt07", width:"61", expand:"up+down",size:9});
	this.text_8.setTransform(346,184.2);

	this.text_9 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt08", width:"60", expand:"up+down",size:9});
	this.text_9.setTransform(284,184.2);
	...
	this.text_13.setTransform(146,112);

	this.text_14 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt03", width:"88.95", expand:"up+down",size:9});
	this.text_14.setTransform(4,28);
...
(lib.bublle1 = function() {
	...
	// Layer 1
	this.text_15 = new BubbleComp({x:"0",y:"0",width:"210",size:"10",compId:"ID_bubble_01",align:"left",tailPosition:"6",tailFlip:"0",extend:"right"});
...
//	this.text_15.lineHeight = 13;
	this.text_15.setTransform(-10,0);
