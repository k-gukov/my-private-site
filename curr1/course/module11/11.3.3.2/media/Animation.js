...
(lib.highlight_8 = function() {
	...
	this.instance.setTransform(90,-4,1,1,0,0,0,64,8.5);

	// highlight
	this.instance_1 = new lib.Arrow();
	this.instance_1.setTransform(137.5,-4,1.5,1.5,180,0,0,5,0);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#F26200").ss(3,1,1).p("AB9AAIj5AA");
	this.shape.setTransform(154,-4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#F26200").ss(2,1,1).p("AzOhvMAm6AAAIAACAIAABfImaAAMgggAAAIgdAAIAAjfg");
	this.shape_1.setTransform(293,-4);
...
(lib.highlight_6 = function() {
	...
	this.instance_1.setTransform(90,-3,1,1,0,0,0,64,8.5);


	// highlight
	this.instance = new lib.Arrow();
	this.instance.setTransform(137.5,-5,1.5,1.5,180,0,0,5,0);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#F26200").ss(3,1,1).p("AB9AAIj5AA");
	this.shape.setTransform(154,-5);
...
(lib.highlight_5 = function() {
	...
	this.instance.setTransform(90,12,1,1,0,0,0,64,8.5);

	// higjlight
	this.instance_1 = new lib.Arrow();
	this.instance_1.setTransform(137.5,12,1.5,1.5,180,0,0,5,0);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#F26200").ss(3,1,1).p("AB9hfIiUAAIAAC/IhlAA");
	this.shape.setTransform(153.7,3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#F26200").ss(2,1,1).p("ATsAyMgnXAAAIAAhjMAnXAAAg");
	this.shape_1.setTransform(293,-9);
...
(lib.highlight_4 = function() {
	...
	this.instance.setTransform(90,-7,1,1,0,0,0,64,8.5);

	// highlights
	this.instance_1 = new lib.Arrow();
	this.instance_1.setTransform(137.5,-9,1.5,1.5,180,0,0,5,0);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#F26200").ss(3,1,1).p("AB9AAIj5AA");
	this.shape.setTransform(154,-9);
...
(lib.highlight_2 = function() {
	...
	this.instance.setTransform(90,-1,1,1,0,0,0,64,8.5);

	// highlight
	this.instance_1 = new lib.Arrow();
	this.instance_1.setTransform(137.5,-1,1.5,1.5,180,0,0,5,0);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#F26200").ss(3,1,1).p("AB9AAIj5AA");
	this.shape.setTransform(154,-1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#F26200").ss(2,1,1).p("ATsD9MgnXAAAIAAn5MAnXAAAg");
	this.shape_1.setTransform(293,12);
...
(lib.highlight_1 = function() {
	...
	this.instance.setTransform(90,-2,1,1,0,0,0,64,8.5);

	// highlights
	this.instance_1 = new lib.Arrow();
	this.instance_1.setTransform(137.5,-2,1.5,1.5,180,0,0,5,0);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#F26200").ss(3,1,1).p("AB9AAIj5AA");
	this.shape.setTransform(154,-2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#F26200").ss(2,1,1).p("ATsBmMgnXAAAIAAjLMAnXAAAg");
	this.shape_1.setTransform(293,-2);
