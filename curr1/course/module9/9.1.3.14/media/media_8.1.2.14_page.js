...
(slideViewDidLoad = function(_container,_id)
{
		...
		var textBox	= getCJSElement("TEXTBOX",{subType:"CLOSABLE",x:"305.6",y:"306.9",width:"452.65",height:"95.9",titleId:"txt_incorrect",bodyId:"txt_body_incorrect",animated:"0",visible:"0"});
...
function newBtnClickHandler()
{
	...
	function numberHostVal(evt) {
	  ...
	  if( !regex.test(key)){
		...
		if((evt.keyCode >= 96 && evt.keyCode <= 105)||(evt.keyCode == 190))
		{
