...
(SyntaxComp = function (o) {
	...
	//Router output area
	b = getCJSElement("ROUTER_SYNTAX",{x:6,y:20,width:o.width-6,height:o.height-60,syntax:1});
	t.addChild(b);
	...
	var but1_x = spacing;
	var but2_x = spacing + 140 + spacing/2;
	var but3_x = spacing + 140 + (spacing/2) + 140 + (spacing/2);
	...
	btn = getCJSElement("SYNTAX_BUTTON",{x:but1_x,y:o.height-30,width:140,height:16,size:12,id:"reset",div:o.div,compId:o.resetId,callback:t.cb});
	t.addChild(btn);
	
	btn = getCJSElement("SYNTAX_BUTTON",{x:but2_x,y:o.height-30,width:140,height:16,size:12,id:"showme",div:o.div,compId:o.showMeId,callback:t.cb});
	t.addChild(btn);
	
	btn = getCJSElement("SYNTAX_BUTTON",{x:but3_x,y:o.height-30,width:140,height:16,size:12,id:"showall",div:o.div,compId:o.showAllId,callback:t.cb});
	t.addChild(btn);
