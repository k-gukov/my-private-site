...
(lib.ID_s2_txt13 = function() {
	...
	this.text_15.setTransform(-10,0.1);
...
(lib.ID_s2_txt12 = function() {
	...
	// Layer 1
	this.text_15 = new DOMObject({type:"TEXT",compId:"ID_s2_txt12",width:"74",expand:"down",align:"center"});
	this.text_15.setTransform(30,4.1);
...
(lib.ID_s1_txt12 = function() {
	...
	this.text_20.setTransform(12.1,3.6);
...
(lib.movie_2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_28).wait(131).to({alpha:1},0).wait(89));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(14).to({alpha:1},0).wait(289));
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{},true);
	...
	this.instance_46.setTransform(363.1,403.6,1,1,0,0,0,68,8.5);
