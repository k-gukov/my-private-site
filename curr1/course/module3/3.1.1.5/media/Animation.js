...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{},true);
	...
	this.instance_4.setTransform(279,211.8,1,1,0,0,0,31.4,8.1);
	this.instance_4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(258).to({alpha:1},0).wait(121).to({alpha:0},0).wait(1));
...
//	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(24).to({_off:false},0).wait(15).to({alpha:0},20).to({alpha:1},20).to({alpha:0},20).to({alpha:1},20).to({alpha:0},20).to({y:177.1,alpha:1},20).to({y:177.1,alpha:0},20).to({alpha:1},20).to({alpha:0},10).wait(50).to({alpha:1},0).to({alpha:0},20).to({alpha:1},20).to({alpha:0},20).to({alpha:1},20).to({alpha:0},20).to({y:177.1,alpha:1},19).wait(2));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(24).to({_off:false},0).wait(15).to({alpha:0},20).to({alpha:1},20).to({alpha:0},20).to({alpha:1},20).to({alpha:0},20).to({y:177.2,alpha:1},20).to({y:177.2,alpha:0},20).to({alpha:1},20).to({alpha:0},10).wait(50).to({alpha:1},0).to({alpha:0},20).to({alpha:1},20).to({alpha:0},20).to({alpha:1},20).to({alpha:0},20).to({x:274.1,y:177.2,alpha:1},19).wait(1).to({alpha:0},0).wait(1));
