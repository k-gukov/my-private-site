...
(Animation = function(control,id){		
		...
		{src:"images/media_3117.png", id:"media_3117"}
	];
		return manifest;	
});
...
(slide1 = function(slideContainer){
	...
	btn = getCJSElement("BLUE_BUTTON",{x:6,y:324.5,width:130,height:28,compId:"ID_s1_btn01",callback:slidebtnHandler1,id:"1"});
	...
	btn = getCJSElement("BLUE_BUTTON",{x:158.95,y:324.5,width:130,height:28,compId:"ID_s1_btn02",callback:slidebtnHandler1,id:"2"});
	...
	btn = getCJSElement("BLUE_BUTTON",{x:309.9,y:324.5,width:130,height:28,compId:"ID_s1_btn03",callback:slidebtnHandler1,id:"3"});
...
(slide2 = function(slideContainer){
	...
	btn = getCJSElement("BLUE_BUTTON",{x:7,y:280,width:130,height:28,compId:"ID_s2_btn01",callback:btnHandler,id:"1"});
	btn.setSelected(true);
	slideContainer.btn_1 = btn;	
	slideContainer.addChild(btn);
	
	btn = getCJSElement("BLUE_BUTTON",{x:157.95,y:280,width:130,height:28,compId:"ID_s2_btn02",callback:btnHandler,id:"2"});
	slideContainer.btn_2 = btn;
	slideContainer.addChild(btn);
	
	btn = getCJSElement("BLUE_BUTTON",{x:308.9,y:280,width:130,height:28,compId:"ID_s2_btn03",callback:btnHandler,id:"3"});
	slideContainer.btn_3 = btn;
	slideContainer.addChild(btn);
