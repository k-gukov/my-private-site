...
(lib.fold = function() {
	 this.initialize();
	this.instance = new DOMObject({type:"IMAGE",image:img.fold});
	this.addChild(this.instance);
}).prototype = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,396,161);


(lib.senderbg = function() {
	 this.initialize();
	this.instance = new DOMObject({type:"IMAGE",image:img.senderbg});
	this.addChild(this.instance);
}).prototype = new cjs.Container();
...
(lib.ID_box7 = function() {
	...
	// ID_box7
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_box7", width:"56.05",  size:"8", expand:"down"});	
...
(lib.ID_box3 = function() {
	...
	// ID_box3
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_box3", width:"56",  size:"8", expand:"down"});	
...
(lib.ID_box2 = function() {
	...
	// ID_box2
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_box2", width:"56",  size:"8", expand:"down"});	
...
(lib.ID_box1 = function() {
	...
	// ID_box1
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_box1", width:"56",  size:"8", expand:"down"});	
...
(lib.ID_bodyText = function() {
	...
	// ID_bodyText
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_bodyText", width:"66.9",  size:"8", expand:"down"});	
...
(lib.stamp = function() {
	...
	this.instance.setTransform(7.5,10,0.241,0.239);
...
(lib.opening = function() {
	...
	// bg
	this.instance = new lib.fold();
	this.instance.setTransform(-135,-47.4,0.689,0.688);
...
p.nominalBounds = new cjs.Rectangle(-135,-47.4,273,110.8);
...
(lib.letter = function() {
	...
	this.shape.graphics.f("#FBFBFB").s().p("A0mNSIAA6jMApNAAAIAAajg");
	this.shape.setTransform(131.9,85);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_7 = new lib.new_Envelope_Graphic();
	this.instance_7.setTransform(154.1,134.4,1,1,0,0,0,87,50.5);

	this.instance_7.shadow = new cjs.Shadow("rgba(0,0,0,1)",0,3,5);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(10).to({regX:0,regY:0,x:67.1,y:93.9},0).to({x:66.6,y:158},24,cjs.Ease.get(1)).wait(80).to({scaleX:0.47,scaleY:0.47,y:18.4},36,cjs.Ease.get(1)).wait(945));

	// envelope flap
	this.instance_8 = new lib.opening();
	this.instance_8.setTransform(220.3,159.6,1.2,0.011,0,0,0,0,45.5);
	this.instance_8.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(34).to({regX:1.4,x:222,alpha:1},0).to({regX:0,regY:46,scaleX:1.18,scaleY:1.2,x:219.3},24,cjs.Ease.get(1)).wait(32).to({scaleX:1.2,x:220.3},0).to({regY:45.5,scaleY:0.01},18,cjs.Ease.get(1)).wait(6).to({alpha:0},0).wait(981));
	...
	this.instance_9 = new lib.letter();
	this.instance_9.setTransform(71.5,124.8,1.207,1.207);
	this.instance_9.alpha = 0;
	this.instance_9.shadow = new cjs.Shadow("rgba(0,0,0,1)",0,3,5);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(65).to({scaleX:1,scaleY:1,x:92.5,y:96.7,alpha:1},0).to({y:10.3},20,cjs.Ease.get(1)).wait(44).to({scaleX:1.21,scaleY:1.21,x:71.5,y:124.8},21,cjs.Ease.get(1)).wait(51).to({scaleX:0.54,scaleY:0.54,x:245.6,y:18.4},30,cjs.Ease.get(1)).wait(864));

	// table text 6
	this.instance_10 = new lib.ID_john();
	this.instance_10.setTransform(350.1,287.9,1,1,0,0,0,24.8,43.1);
	...
	this.instance_11.setTransform(290.4,287.6,1,1,0,0,0,36,43.8);
	...
	this.instance_12.setTransform(222,287.6,1,1,0,0,0,30,43.8);
	...
	this.instance_13.setTransform(163.6,287.9,1,1,0,0,0,30,43.1);
	...
	this.instance_14.setTransform(102.2,287.6,1,1,0,0,0,30,43.8);
	...
	this.instance_15.setTransform(40.8,287.9,1,1,0,0,0,30,43.1);
	...
	this.shape_1.graphics.f("#FFFFFF").s().p("Egh9ASkMAAAglHMBD7AAAMAAAAlHg");
	this.shape_1.setTransform(220.4,237.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(255,255,255,0)").s().p("Egh9ASkMAAAglHMBD7AAAMAAAAlHg");
	this.shape_2.setTransform(220.4,237.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1}]},238).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[]},1).wait(841));


	// ID_box1
	this.instance_16 = new lib.ID_box1();
	this.instance_16.setTransform(38.2,160.4,1,1,0,0,0,30,32);
	...
	this.instance_17.setTransform(99.6,160.4,1,1,0,0,0,30,32);
	...
	this.instance_18.setTransform(161.1,160.4,1,1,0,0,0,30,32);
	...
	this.instance_19.setTransform(219.5,160.4,1,1,0,0,0,30,32);
	...
	this.instance_20.setTransform(288.4,160.4,1,1,0,0,0,35.5,32);
	...
	this.instance_21.setTransform(347.9,160.4,1,1,0,0,0,24.6,32);
	...
	this.instance_22.setTransform(405.8,160.4,1,1,0,0,0,30,32);
	...
	this.instance_23.setTransform(63.6,230,1,1,0,0,0,55.2,6.5);
	...
	this.instance_24.setTransform(283,230,1,1,0,0,0,150.3,6.5);
	...
	this.instance_25.setTransform(219.9,239.2,1,1,0,0,0,214.9,112.8);
