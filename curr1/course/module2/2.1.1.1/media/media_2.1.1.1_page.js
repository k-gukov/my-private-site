...
(slideViewDidLoad = function(slideContainer){
	...
	function loadShellImages()
	{
		...
		var sideImage1 = getCJSElement("IMAGE",{x:300,y:70,src:"2_1_1_1_B.jpg",subType:"STD", width:122.75, height:87.9});
		
		var textElement1 = getCJSElement("TEXT",{compId:"ID_s1_txt02",x:"420",y:"22",width:"25",expand:"down",align:"center",size:"10"});
		...
		var sideImage2 = getCJSElement("IMAGE",{x:300,y:0,src:"2_1_1_1_A.jpg",subType:"STD", width:125, height:63});
		
		var textElement2 = getCJSElement("TEXT",{compId:"ID_s1_txt03",x:"425",y:"110",width:"25",expand:"down",align:"center",size:"10"});
