...
(lib.ID_txt07 = function() {
	...
	// ID_txt07
	this.text = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt07", width:"113.8", expand:"up",class:"orangeCallOut"}); 
...
(lib.ID_txt06 = function() {
	...
	// ID_txt06
	this.text = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt06", width:"132.6", expand:"up",class:"orangeCallOut"}); 
	this.addChild(this.text);
}).prototype = p = new cjs.Container();
